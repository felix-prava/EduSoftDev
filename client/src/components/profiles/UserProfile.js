...
const UserProfile = ({
  ...
  const editUserProfileLabel = myProfileTranslations.editUserProfile[language];
                  ...
                  {currentUser.role === 'admin' && currentUser._id !== id && (
                    <Link to={`/profiles/${id}/edit`}>
                      ...
                      >
                        ...
                        <div className='pt-0.5'>{editUserProfileLabel}</div>
                      </button>
                    </Link>
                  )}
                  {currentUser._id === id && (
                    <Fragment>
                      <Link to='/edit-profile'>
                        ...
                        >
                          ...
                          <div className='pt-0.5'>{editProfileLabel}</div>
                        </button>
                      </Link>
                ...
                <div className='lg:col-span-2'>
                  {profile && (
                    <div className='bg-white mb-8'>
                      ...
                      {social && <ProfileSocialItems social={social} />}
